  ...
  private async logLongDowntime(botUsername: string, ownerId: string) {
    ...
    await channel?.send(
      new MessageEmbed()
        ...
        .setDescription(`<@!${ownerId}>, your bot \`${botUsername}\` has been offline for over 15 minutes. Please make sure that your bot is online and check up on your bot! \n You will be pinged on a 15 minute interval until your bot stays online. `)
    );
  }
}
